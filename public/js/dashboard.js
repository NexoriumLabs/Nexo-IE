...
function renderWorkspace(obProducts) {
  ...
  if (!obProducts.length) {
    container.innerHTML = `<div style="background:#0d2020; border:0.5px solid var(--teal-border); border-radius:12px; padding:32px; text-align:center; color:var(--text-muted); font-size:13px;">No OB data yet. Complete time studies to see product health.</div>`;
    return;
  }
  ...
  const cardHtml = (p, faded) => {
    ...
    return `
      <div style="background:#0d2020; border:0.5px solid ${borderColor}; border-radius:12px; padding:16px; opacity:${faded?'0.45':'1'}; transition:opacity 0.2s;"
        ...
        <div style="margin-bottom:12px;">
          <div style="display:flex; height:6px; border-radius:3px; overflow:hidden; gap:1px; margin-bottom:6px;">
            ...
            ${p.balanced > 0 ? `<div style="flex:${p.balanced}; background:var(--teal-light); border-radius:3px; opacity:0.6;"></div>` : ''}
          </div>
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:6px;">
          <div style="background:#060f0f; border-radius:8px; padding:8px;">
      ...
      <div style="background:#0d2020; border:0.5px solid var(--teal-border); border-radius:12px; padding:20px;">
        ...
        <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:8px; margin-bottom:16px;">
          ${['cutting','sewing','finishing'].map(p => {
            ...
            return `
              <div style="background:#060f0f; border-radius:8px; padding:10px; text-align:center;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px;">
          ...
          <div style="display:flex; background:#060f0f; border-radius:6px; overflow:hidden; border:0.5px solid var(--border);">
