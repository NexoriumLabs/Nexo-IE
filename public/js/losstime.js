  ...
  content.innerHTML = `
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; align-items:start;">
      ...
      <div>
        ...
        <div style="background:var(--surface); border:0.5px solid var(--teal-border); border-radius:12px; padding:16px;">
...
function ltRenderEntriesList(ltData) {
  ...
  <div onclick="ltOpenEntry(${entry.id})"
    style="
      ...
      border:0.5px solid ${logged > 0 ? 'var(--teal-border)' : 'var(--border)'};
      border-radius:10px;
      padding:14px 16px;
      margin-bottom:10px;
      cursor:pointer;
    ...
    onmouseout="
      this.style.borderColor='${logged > 0 ? 'var(--teal-border)' : 'var(--border)'}';
    ...
    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px;">
      <div>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center;">
          ...
          <div style="font-size:11px; color:${logged > 0 ? 'var(--teal-light)' : 'var(--text-muted)'};">
...
async function ltOpenEntry(efficiencyEntryId) {
  ...
  content.innerHTML = `
    <div style="display:flex; align-items:center; gap:12px; margin-bottom:20px;">
      ...
      <div style="background:var(--surface); border:0.5px solid var(--teal-border); border-radius:10px; padding:10px 16px; text-align:center;">
...
function ltHistoryView(view) {
  ...
  container.innerHTML = Object.keys(grouped).sort((a,b) => b.localeCompare(a)).map(key => {
    ...
    return `
      <div style="margin-bottom:20px; background:var(--surface); border:0.5px solid var(--teal-border); border-radius:12px; padding:16px;">
